...
class Portfolio(models.Model):
    ...
    securities = models.ManyToManyField(Security, through='Position')
...
class Position(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.security.securityName} by {self.portfolio.user.firstname} {self.portfolio.user.lastname}'
